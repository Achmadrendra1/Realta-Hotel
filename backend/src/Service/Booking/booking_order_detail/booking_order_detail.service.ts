...
export class BookingOrderDetailService {
    ...
    async createBookingOrderDetail(field : BookingOrderDetail) : Promise <any> {
        return await this.bookingOrderDetail.save({
    ...
    async updateBookingOrderDetail(id : number, field : BookingOrderDetail) : Promise <any> {
        return await this.bookingOrderDetail.update(
        {
            bordeId : id
        },{
            borderBoorId    : field.borderBoorId,
