...
export class BookingOrderDetailExtraService {
    ...
    async createBookingOrderDetailExtra (field : BookingOrderDetailExtra) : Promise <any> {
        return await this.bookingOrderDetailExtra.save({
    ...
    async updateBookingOrderDetailExtra (id : number, field : BookingOrderDetailExtra) : Promise <any> {
        return await this.bookingOrderDetailExtra.update({
            boexId : id
        },{
            boexPrice       : field.boexPrice,
            boexQty         : field.boexQty,
